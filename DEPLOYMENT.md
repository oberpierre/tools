...
>
> **Note**: `registry.host`, `registry.username` and `registry.password` are required together; declaring only some of them, or leaving one empty, is rejected before anything is applied.
...
| Variable                  | Required | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Example                                                                                                                                           |
| ------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| ansible_inventory_content | X        | Content of the Ansible inventory file to use for deployment. A value with no non-blank, non-comment line (unset, empty or comments-only) fails the run before `ansible-playbook` starts, naming this secret; otherwise `hosts: all` would match no host and the run would report success while deploying nothing.                                                                                                                                                                                                                                                                                                                                                                         | `cluster.example.com ansible_user=deploy`                                                                                                         |
