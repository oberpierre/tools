...
- **Kubernetes**:
  ...
  - [`k8s_deploy_workloads.yml`](./k8s_deploy_workloads.yml): Deploying an application as any number of Deployments and CronJobs sharing a namespace and the central PostgreSQL and Redis instances, each optionally exposed by its own Service and Ingress. See the [Kubernetes Deployment Guide](../DEPLOYMENT.md#multi-workload-deployments) for the variable file schema.
